...
const AddressForm = ({ register, errors, onSubmit }: AddressFormProps) => {
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <button
        type="submit"
        className="w-full py-3  text-white font-medium rounded bg-[#1e6553] hover:bg-[#1e6553] transition-colors"
