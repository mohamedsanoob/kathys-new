...
const Navbar = () => {
    ...
    return (
        <nav className="shadow-sm bg-white z-10 w-full border-b border-gray-100">
            ...
            {/* Mobile Menu Overlay */}
            {isMobileMenuOpen && (
                <div className="fixed inset-0 bg-opacity-50 z-200 md:hidden" onClick={toggleMobileMenu} />
            )}

            {/* Mobile Slide-in Menu */}
            <div className={`fixed top-0 left-0 w-4/5 h-screen bg-white z-200 shadow-lg border-r border-gray-100 transform transition-transform duration-300 ease-in-out md:hidden ${
