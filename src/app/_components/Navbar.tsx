...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <nav className="fixed md:relative top-0 left-0 right-0 shadow-sm bg-white z-50 w-full border-b border-gray-100">
            ...
            {/* Mobile Menu Overlay */}
            {isMobileMenuOpen && (
                <div className="fixed inset-0 bg-opacity-50 z-40 md:hidden" onClick={toggleMobileMenu} />
            )}

            {/* Mobile Slide-in Menu */}
            <div className={`fixed top-0 left-0 w-4/5 h-screen bg-white z-50 shadow-lg border-r border-gray-100 transform transition-transform duration-300 ease-in-out md:hidden ${
                ...
                <div className="flex flex-col h-full">
                    ...
                    <ul className="flex flex-col gap-4 font-medium p-4 flex-grow overflow-y-auto">
                        ...
                        <li className="cursor-pointer hover:text-[#1e6553] transition-colors py-2 border-b border-gray-50">
                            <Link href="/categories" className="block" onClick={toggleMobileMenu}>CATEGORIES</Link>
                        </li>
                        <li
                            className="cursor-pointer hover:text-[#1e6553] transition-colors py-2 border-b border-gray-50"
                            onClick={() => {
                        ...
                        <li className="cursor-pointer hover:text-[#1e6553] transition-colors py-2">
                            <Link href="/contact" className="block" onClick={toggleMobileMenu}>CONTACT</Link>
                        </li>
                    </ul>
                </div>
            </div>
