...
// Async Server Component — collections + products fetched on the server.
// No client spinner; home page streams with content present.
async function Collections() {
  const categoriesWithProducts = await getCollectionsWithProductsServer();
  ...
  return (
    <div className="max-w-[1290px] mx-auto px-4">
      {categoriesWithProducts
        ...
        .map((category, index) => {
          // Copy before sort so we don't mutate the shared cached array.
          ...
          return (
            <div key={category.id} className="mb-16 last:mb-8">
              ...
              {/* Products Grid - sorted by position */}
                      ...
                      <div className="relative h-[250px] md:h-[440px]">
                        ...
                        <div
                          className={`absolute top-2 right-2 p-2 ${
                            outOfStock ? "bg-gray-300" : "bg-white/80 hover:bg-white"
